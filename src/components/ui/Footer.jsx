export default function Footer() {
  ...
  return (
    <footer className="mt-4 flex items-end justify-between px-5 py-4 text-body-4 sm:flex md:text-body-3">
      ...
      <button
        onClick={toTop}
        className="group col-span-2 mb-5 flex w-fit items-center space-x-2 md:mb-0 2xl:text-body-1"
      >
