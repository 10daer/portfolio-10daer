    ...
    >
      ...
      >
        <div className="col-span-4">
          ...
          >
            I am currently available for team collaboration and freelance work.
          </p>
          <form
            name="contact"
            action="/contact"
          ...
          >
            ...
            <div className="my-4 w-fit self-end">
              <RoundedButton backgroundColor="#666666">
                <button
                  type="submit"
                  className="z-10 m-2 mx-4 hover:bg-transparent hover:text-primary-200"
                >
                  Send Message
                </button>
              </RoundedButton>
        ...
        <div className="col-span-2 grid grid-cols-1 gap-x-4 gap-y-8 text-accent-300 sm:grid-cols-2 sm:gap-y-0 md:grid-cols-1">
          <div className="flex items-start justify-between md:flex-col md:justify-evenly">
            <div className="space-y-3 ">
              <h4 className="text-body-1 font-semibold 2xl:text-4xl">
                Contact Details
              </h4>
              <div className="flex flex-col space-y-3 pl-2 text-body-2 font-semibold 2xl:text-3xl">
                <a
            ...
            <div className="space-y-3 ">
              ...
              <div className="space-y-3 pl-2 text-body-2 2xl:text-3xl">
          ...
          <div className="space-y-3 ">
            ...
            <div className="space-y-2 pl-2 text-body-2 2xl:text-3xl">
              <p>
                Osun, Nigeria <br></br>
                {time}
              </p>
